...
//            ObjectMapper mapper = new ObjectMapper();
        ...
        case "GET":
            ...
            break;
        case "POST":
            request = builder.POST(HttpRequest.BodyPublishers.ofString(body)).header("Content-Type", "application/json").build();
            break;
        case "PUT":
            request = builder.PUT(HttpRequest.BodyPublishers.ofString(body)).header("Content-Type", "application/json").build();
            break;
        case "DELETE":
