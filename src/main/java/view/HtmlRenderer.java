...
public class HtmlRenderer {
	...
	public static String renderCoursesPage(HashMap<String, Object> data) {
		...
		ArrayList<HashMap<String, Object>> courses = (ArrayList<HashMap<String, Object>>) data.get(
			"courses"
		);
		for (HashMap<String, Object> entry : courses) {
			HashMap<String, Object> classTimeData = (HashMap<String, Object>) entry.get(
				"classTime"
			);
			HashMap<String, String> examTimeData = (HashMap<String, String>) entry.get(
				"examTime"
			);
	...
	public static String renderStudentProfilePage(HashMap<String, Object> data) {
		...
		ArrayList<HashMap<String, Object>> passedGrades = (ArrayList<HashMap<String, Object>>) data.get(
			"passedCoursesGrades"
		);
		Element table = reportDoc.getElementsByTag("table").last();
	...
	public static String renderSingleCoursePage(HashMap<String, Object> data) {
		...
		HashMap<String, Object> classTimeData = (HashMap<String, Object>) data.get(
			"classTime"
		);
		String[] courseValues = {
			"Code: " + data.get("code"),
	...
	public static String renderChangePlanPage(HashMap<String, Object> data) {
		...
		ArrayList<HashMap<String, Object>> chosenOfferings = (ArrayList<HashMap<String, Object>>) data.get(
			"chosenOfferings"
		);
